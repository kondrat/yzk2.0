...
class ClientsController extends AppController {
    ...
    public $name = 'Clients';
    //??toDel??
    public $publicActions = array('todel','getYnClData');
...
//--------------------------------------------------------------------
    ...
    function beforeFilter() {
        parent::beforeFilter();
        //default title
        $this->set('title_for_layout', __('Campanies'));
        //allowed actions
        $this->Auth->allow(
                //'index',
                //'view'
    ...
    public function getYnClData() {
        ...
        if ($this->request->is('ajax')) {
            ...
            if ($this->pathToCerts == null) {
                $contents = json_encode(array('error' => __('No client\'s data from yandex!')));
